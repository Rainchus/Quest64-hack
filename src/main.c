...
SpiritTable newSpiritTable[] = {
    ...
    {0x0015, 0x0000, 0x0002, 0x0000, &spiritLocations[82]},
    {0x0015, 0x0006, 0x0001, 0x0000, &spiritLocations[84]},
    {0x0016, 0x0001, 0x0001, 0x0000, &spiritLocations[85]},
    {0x0016, 0x0017, 0x0002, 0x0000, &spiritLocations[86]},
    {0x0017, 0x0013, 0x0001, 0x0000, &spiritLocations[88]},
    {0x0017, 0x0017, 0x0001, 0x0000, &spiritLocations[89]},
    {0x0018, 0x0000, 0x0004, 0x0000, &spiritLocations[90]},
    {0x0018, 0x0002, 0x0002, 0x0000, &spiritLocations[94]},
    {0x0019, 0x0001, 0x0001, 0x0000, &spiritLocations[96]},
    {0x0019, 0x0004, 0x0001, 0x0000, &spiritLocations[97]},
    {0x0019, 0x0009, 0x0001, 0x0000, &spiritLocations[98]},
};
